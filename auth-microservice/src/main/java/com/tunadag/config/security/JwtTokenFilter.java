...
public class JwtTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
         ...
         * ilk olarak buna bakarız. Ayrıca eğer kullanıcı zaten önceden bir kimlik kartı almış yani kendisini doğrulamış
         * ise yine burada ek işlem yapmamak adına gelen isteği olduğu gibi iade ederiz.
         */
